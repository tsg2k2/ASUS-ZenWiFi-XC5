...
#elif defined(CONFIG_CPU_LITTLE_ENDIAN) || defined(CONFIG_ARM) || defined(CONFIG_ARM64)
...
#define BLOG_TEREDO_SERVER_PORT   3544
 ...
 *------------------------------------------------------------------------------
 */
#if defined(CONFIG_CPU_LITTLE_ENDIAN) || defined(CONFIG_ARM) || defined(CONFIG_ARM64)
/*
 *------------------------------------------------------------------------------
