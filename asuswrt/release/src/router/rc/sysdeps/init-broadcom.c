...
set_wan_tag(char *interface) {
	...
	case MODEL_RTN10PV2:	/* P4  P3 P2 P1 P0 P5 */
		...
		if (nvram_match("switch_wantag", "unifi_home")) {
			...
			eval("et", "robowr", "0x34", "0x6", "0x3000");
			/* vlan500ports= 4 5 */
			eval("et", "robowr", "0x34", "0x8", "0x011f4030");	/*0000|0011|0000*/
			eval("et", "robowr", "0x34", "0x6", "0x31f4");
			/* vlan400ports= 1 4 */
			eval("et", "robowr", "0x34", "0x8", "0x01190012");	/*0000|0001|0010*/ /*Just forward without untag*/
			eval("et", "robowr", "0x34", "0x6", "0x3190");
		} else {	/* manual */
							/* WAN L1 L2 L3 L4 CPU */
			const int ports[SWPORT_COUNT] = { 4, 3, 2, 1, 0, 5 };
	...
	case MODEL_RTN14UHP:	/* P4  P0 P1 P2 P3 P5 */
		...
		if (nvram_match("switch_wantag", "unifi_home")) {
			...
			eval("et", "robowr", "0x34", "0x6", "0x3000");
			/* vlan500ports= 4 5 */
			eval("et", "robowr", "0x34", "0x8", "0x011f4030");	/*0000|0011|0000*/ /*Dont untag WAN port*/
			eval("et", "robowr", "0x34", "0x6", "0x31f4");
			/* vlan400ports= 2 4 */
			eval("et", "robowr", "0x34", "0x8", "0x01190014");	/*0000|0000|0101*/ /*Just forward without untag*/
			eval("et", "robowr", "0x34", "0x6", "0x3190");
	...
	case MODEL_RTN10U:	/* P0  P4 P3 P2 P1 P5 */
		...
		if (nvram_match("switch_wantag", "unifi_home")) {
			...
			eval("et", "robowr", "0x34", "0x6", "0x3000");
			/* vlan500ports= 0 5 */
			eval("et", "robowr", "0x34", "0x8", "0x011f4021");	/*0000|0010|0001*/ /*Dont untag WAN port*/
			eval("et", "robowr", "0x34", "0x6", "0x31f4");
			/* vlan400ports= 2 0 */
			eval("et", "robowr", "0x34", "0x8", "0x01190005");	/*0000|0000|0101*/ /*Just forward without untag*/
			eval("et", "robowr", "0x34", "0x6", "0x3190");
		} else {	/* manual */
							/* WAN L1 L2 L3 L4 CPU */
			const int ports[SWPORT_COUNT] = { 0, 4, 3, 2, 1, 5 };
...
_dprintf("*** Multicast IPTV: config Singtel TR069 on wan port ***\n");
	...
	case MODEL_RTAC53U:	/* P0  P1 P2 P3 P4 P5 */
		...
		if (nvram_match("switch_wantag", "unifi_home")) {
			...
			eval("et", "robowr", "0x34", "0x6", "0x3001");
			/* vlan500ports= 0 5 */
			eval("et", "robowr", "0x34", "0x8", "0x011f4021", "0x4");/*0000|0010|0001*/ /*Dont untag WAN port*/
			eval("et", "robowr", "0x34", "0x6", "0x31f4");
			/* vlan400ports= 3 0 */
			eval("et", "robowr", "0x34", "0x8", "0x01190009", "0x4");/*0000|0000|1001*/ /*Just forward without untag*/
			eval("et", "robowr", "0x34", "0x6", "0x3190");
		} else {	/* manual */
							/* WAN L1 L2 L3 L4 CPU */
			const int ports[SWPORT_COUNT] = { 0, 1, 2, 3, 4, 5 };
...
int check_used_stb_voip_port(int lan)
{
	...
	if (!nvram_match("switch_wantag", "none") && !nvram_match("switch_wantag", "")) {
		...
		if (!strcmp(nvram_safe_get("switch_wantag"), "unifi_biz"))
			...
			used_port = 0x4;	/* LAN3 for voip */
		else if (!strcmp(nvram_safe_get("switch_wantag"), "unifi_biz_voip"))
			used_port = 0x4;	/* LAN3 for voip */
		else	/* For manual */
		{
